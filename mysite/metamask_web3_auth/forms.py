...
from metamask_web3_auth.utils import validate_eth_address
...
class SignupForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields[app_settings.WEB3AUTH_USER_ADDRESS_FIELD].help_text = '<small class="text-muted">Enter your metamask address</small>'
